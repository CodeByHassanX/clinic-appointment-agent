    ...
    try:
        ...
        try:
            ...
            payload = {
                ...
                "patient_email": (request.patient_email if request.patient_email else "mohamadhasanpkk101@gmail.com"), # Hardcoded for testing, usually fetched from DB
        ...
        return {
            ...
            "appointment_id": appointment.data[0]["id"], "webhook_status": webhook_status
        }
