    ...
    try:
        ...
        try:
            ...
            payload = {
                ...
                "patient_email": (request.patient_email.strip() if request.patient_email and request.patient_email.strip() else "mohamadhasanpkk101@gmail.com"), # Hardcoded for testing, usually fetched from DB
    ...
    try:
        ...
        try:
            ...
            payload = {
                ...
                "patient_email": (request.patient_email.strip() if request.patient_email and request.patient_email.strip() else "mohamadhasanpkk101@gmail.com"),
